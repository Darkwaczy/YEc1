...
export declare function isImportantAgentFile(filePath: string, projectRootDir: string): boolean;
...
export declare function processPushChangesArgs(opts: PushChangesArgs): PushChangesOptions;
